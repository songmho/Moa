...
public class TeamDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser != null &&
                intent.getStringExtra("username").equals(currentUser.getUsername())) {         //로그인이 되어 있고 현재 유저가 팀장일 때
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> list, ParseException e) {
                ...
                if (!list.isEmpty()) {
                    ...
                    ParseQuery<ParseUser> user = appliedUser.getQuery();             //릴레이션을 가지고 쿼리문 돌림
                            ...
                            query.findInBackground(new FindCallback<ParseObject>() {
                                ...
                                public void done(List<ParseObject> list, ParseException e) {
                                    if (!list.isEmpty()) {        //리스트가 비어있지 않을 때
                                        ...
                                        input_user.add(currentUser);     //현재 로그인된 유저를 릴레이션에 추가
