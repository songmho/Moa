...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<MainRecyclerItem> items=new ArrayList<>();
        MainRecyclerItem item=new MainRecyclerItem("버스킹어플","최에스더",5,"blar blar");
        items.add(item);

        recyclerView.setAdapter(new MainRecyclerAdpater(getActivity(),items,R.layout.item_mainrecycler));
