...
import com.team1.valueupapp.activity.MentoringDetailActivity;
...
public class MentoringAdapter extends RecyclerView.Adapter<MentoringAdapter.ViewHolder> {
    ...
    public MentoringAdapter(Context context, List<MentoringItem> items, int rayout) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final MentoringItem item = items.get(position);
