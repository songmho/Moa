...
import com.team1.valueupapp.activity.MentorDetailActivity;
...
public class MentorAdapter extends RecyclerView.Adapter<MentorAdapter.ViewHolder> {
    ...
    public MentorAdapter(Context context, List<MentorItem> items, int layout) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final MentorItem item = items.get(position);
